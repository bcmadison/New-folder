          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono">
                {recommendations.confidence.toFixed(2)}%
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Max Stake</span>
              <span className="font-mono">
                ${recommendations.maxStake.toFixed(2)}
              </span>
            </div>
            <div className="flex items-center justify-between">
              ...
              <span
                className={`font-mono ${
                  recommendations.expectedValue >= 0
                    ? 'text-green-600'
                    : 'text-red-600'
                }`}
              >
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono">
                  {simulation.sharpeRatio.toFixed(4)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Max Drawdown</span>
                <span className="font-mono">
                  {(simulation.maxDrawdown * 100).toFixed(2)}%
                </span>
              </div>
            </div>
          </div>
