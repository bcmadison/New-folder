...
export interface PoeDataBlock {
  ...
  title?: string;
  content: any; // The actual data payload, structure varies by type
  metadata?: Record<string, any>; // Additional metadata, e.g., source, timestamp, relevance score
  style?: Record<string, any>; // Styling hints if Poe source provides them
}
