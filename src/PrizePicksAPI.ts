...
// import { EventMap } from '../../../src/types/core'; // Temporarily remove as EventMap might not have these keys
...
export class PrizePicksAPI {
  ...
  public async fetchProjections(
    ...
    return this.request<PrizePicksAPIResponse<RawPrizePicksProjection>>(endpoint, 'GET', undefined, undefined, params);
  }

  public async fetchProjectionById(projectionId: string): Promise<PrizePicksAPIResponse<RawPrizePicksProjection>> {
